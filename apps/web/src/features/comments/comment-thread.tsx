...
import { commentAnchorId } from '@tack/shared/utils';
...
const bodyClassName = cn(
  'prose-tack min-w-0 text-dense text-text leading-relaxed [&_a]:text-accent [&_code]:rounded-sm [&_code]:bg-surface-2 [&_code]:px-1 [&_p]:my-1',
...
export function CommentBody({ body, bodyHtml }: { body: string; bodyHtml: string }) {
  ...
  return (
    <div
      ...
      // biome-ignore lint/security/noDangerouslySetInnerHtml: markdown is sanitized server side by @tack/services/markdown
