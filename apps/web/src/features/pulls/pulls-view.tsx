...
const REACH_COPY: Record<GithubReach, ReachCopy> = {
  not_installed: {
    ...
    admin: 'Connect GitHub and pick the repositories whose pull requests Tack should mirror.',
  ...
  repositories_untracked: {
    ...
    member:
      'GitHub can see additional repositories this workspace has not switched on. A workspace admin chooses which repositories Tack mirrors.',
    action: 'Check tracked repositories',
  },
  connected: {
    title: 'No pull requests have synced yet',
    admin:
      'Tack mirrors pull requests from tracked repositories. Refresh GitHub repositories if this workspace was connected before PR mirroring was enabled.',
    member:
      'Tack mirrors pull requests from tracked repositories. A workspace admin can refresh the GitHub connection if this stays empty.',
    action: 'Open integrations',
  },
};
                    ...
                    >
                      ...
                      <div className="flex min-w-0 flex-1 flex-col gap-0.5">
                        ...
                        {pull.linkedIssues.length > 0 ? (
                          ...
                          <span className="text-2xs text-faint">No Tack task linked</span>
                        )}
                      </div>
